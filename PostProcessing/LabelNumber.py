...
root = '/media/data/louis/ProgramWorkResult/ViscercialUnet_test_new/InverseTrans'
rootDir = os.path.join(root, "UpsampleResult")

output_root_dir = os.path.join(root, 'MultiOrgan') 
...
for item in organList:
    currentFile = os.path.join(rootDir, item + FileType, 'Predict')
